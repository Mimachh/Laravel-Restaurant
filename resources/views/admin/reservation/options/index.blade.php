...
@section('content')
    ...
    <div class="form-table">
        ...
        <div class="form-row">
            <div class="form-label">
                <p class="label">Confirmation automatique des réservations</p>
            </div>
            <div class="form-field">
        ...
        <div class="form-row">
            <div class="form-label">
                <p class="label">Confirmation manuelle à partir d'une certaine limite</p>
            </div>
            <div class="form-field">
        ...
        <div class="form-row">
            <div class="form-label">
                <p class="label">Confirmation manuelle à partir de </p>
            </div>
            <div class="form-field">
